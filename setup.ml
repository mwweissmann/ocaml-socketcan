...
(* OASIS_START *)
(* DO NOT EDIT (digest: f18dfad51ee69574bfc73a51a2296014) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mwweissmann/ocaml-socketcan/";
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["can_stubs.c"; "bcm_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for SocketCAN";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "socketcan"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "candump.ml"});
               Executable
                 ({
                     cs_name = "heartbeat";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "heartbeat.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\184\004\179_\129x\216\129\199\242\252I\2173F\139";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
